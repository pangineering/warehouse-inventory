...
urlpatterns = [
    ...
    path('buy/info-purchase/<int:pk>', views.purchase_info, name='purchase_info'),
    path('sell/info-order/<int:pk>', views.order_info, name='order_info'),
    ...
    path('sell/edit-order/<int:pk>', views.update_order, name='update_order')
]
